...
class 3d_printer_monitor(App):
    def __init__(self, *args, **kwargs):
        if not 'editing_mode' in kwargs.keys():
            super(3d_printer_monitor, self).__init__(*args, static_file_path='./res/')
    ...
    def main(self):
        return 3d_printer_monitor.construct_ui(self)
...
#Configuration
configuration = {'config_multiple_instance': True, 'config_address': '0.0.0.0', 'config_start_browser': True, 'config_enable_file_cache': True, 'config_project_name': '3d_printer_monitor', 'config_resourcepath': './res/', 'config_port': 8081}

if __name__ == "__main__":
    # start(MyApp,address='127.0.0.1', port=8081, multiple_instance=False,enable_file_cache=True, update_interval=0.1, start_browser=True)
    start(3d_printer_monitor, address=configuration['config_address'], port=configuration['config_port'], 
