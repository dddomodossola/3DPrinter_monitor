...
class serial_interface():
    def __init__(self, log_txt_widget):
        self.log_txt_widget = log_txt_widget
        self.sock = None
    ...
    def read_buffer(self, timeout=1.0):
        ...
        while True:
            ...
            if len(buf)<1:
                ...
                self.log_txt_widget.set_text(("recv:"+buf+'\n') + self.log_txt_widget.get_text())
    ...
    def process_next_msg(self):
        if len(self.send_buffer) > 0:    
            ...
            self.log_txt_widget.set_text(("send:"+item['msg']+'\n') + self.log_txt_widget.get_text())
            try:
...
class app_3d_printer_monitor(App):
    ...
    def construct_ui(self):
        ...
        sub_container_hotend.style['width'] = "100%"
        sub_container_hotend.style['justify-content'] = "space-around"
        sub_container_hotend.style['position'] = "static"
        sub_container_hotend.style['overflow'] = "auto"
        sub_container_hotend.style['order'] = "10"
        ...
        fast_commanfs_container.style['left'] = "1px"
        ...
        bt_command_pause.style['left'] = "1px"
        ...
        sub_container_hotbed.style['width'] = "100%"
        sub_container_hotbed.style['justify-content'] = "space-around"
        ...
        sub_container_connection.style['order'] = "1"
        ...
        lbl_connection_status_value.style['order'] = "1"
...
class app_3d_printer_monitor(App):
    ...
    def construct_ui(self):
        ...
        lbl_log.style['position'] = "static"
        sub_container_log.append(lbl_log,'lbl_log')
        txt_log = TextInput(False,'LOG')
        txt_log.attributes['editor_baseclass'] = "TextInput"
        txt_log.attributes['class'] = "TextInput"
        txt_log.attributes['editor_constructor'] = "(False,'LOG')"
        txt_log.attributes['autocomplete'] = "off"
        txt_log.attributes['editor_tag_type'] = "widget"
        txt_log.attributes['editor_varname'] = "txt_log"
        txt_log.attributes['placeholder'] = "LOG"
        txt_log.attributes['editor_newclass'] = "False"
        txt_log.style['top'] = "1px"
        txt_log.style['margin'] = "0px"
        txt_log.style['order'] = "1"
        txt_log.style['overflow'] = "auto"
        txt_log.style['height'] = "200px"
        txt_log.style['display'] = "block"
        txt_log.style['width'] = "100%"
        txt_log.style['position'] = "static"
        sub_container_log.append(txt_log,'txt_log')
        main_container.append(sub_container_log,'sub_container_log')
        sub_container_printjob_status = HBox()
        sub_container_printjob_status.attributes['editor_baseclass'] = "HBox"
        sub_container_printjob_status.attributes['class'] = "HBox"
...
#Configuration
configuration = {'config_address': '0.0.0.0', 'config_start_browser': True, 'config_enable_file_cache': True, 'config_project_name': 'app_3d_printer_monitor', 'config_port': 8081, 'config_resourcepath': './res/', 'config_multiple_instance': True}
